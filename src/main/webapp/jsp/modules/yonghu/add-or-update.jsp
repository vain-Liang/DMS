                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>岗位信息</label>
                                        <span id="gangwei" name="gangwei"  value="无岗位">
                                        </span>
                                        <button id="butt" onclick="lizhi()" style="margin-left: 20px" type="button" class="btn btn-success">离职</button>
                                    </div>
...
<script>
    ...
    function lizhi(){
        ...
        window.sessionStorage.setItem('ganweiId', ruleForm.gangwei)
        window.sessionStorage.setItem('leixing', 2)
        window.location.href = "../shenqingshenhe/add-or-update.jsp"
    }
    ...
    function getDetails() {
        ...
        if (addyonghu != null && addyonghu != "" && addyonghu != "null") {
            ...
            http("yonghu/info/" + updateId, "GET", {}, (res) => {
                ...
                {
                    ruleForm = res.data
                    if(ruleForm.gangwei == 0 || window.sessionStorage.getItem('role') != "基地管理员"){
                        $("#butt").remove();
                    }
                    // 是/否下拉框回显
                    setSelectOption();
    ...
    <!--  当前表的数据回显  -->
        ...
        if(ruleForm.gangwei == 0){
            ...
            $("#gangwei").html(ruleForm.gangweiName);
        }
