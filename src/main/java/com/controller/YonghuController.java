...
public class YonghuController {
    ...
    */
    ...
    public R info(@PathVariable("id") Long id){
        ...
        if(yonghu !=null){
            ...
            if(yonghu.getGangwei() != 0){
                GangweiEntity gangwei = gangweiService.selectById(yonghu.getGangwei());
                BeanUtils.copyProperties( gangwei , view, new String[]{ "id", "createDate"});
            }
            //修改对应字典表字段
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "基地管理员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","基地管理员");
